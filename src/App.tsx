  ...
  return (
    <div className={`${darkMode ? "dark" : ""} relative`}>
      ...
      <div className="bg-stone-100 dark:bg-neutral-900 lg:min-h-lvh sm:min-h-svh max-[640px]:min-h-svh flex flex-col items-center justify-between gap-8 lg:pb-32 py-8">
        <header className="flex flex-col items-center cursor-default select-none">
        ...
        <main className="max-w-3xl w-full max-[640px]:max-w-md min-h-40 p-4">
          ...
          {requesting &&
            <section className="min-h-full min-w-full flex flex-center p-4 justify-center items-center gap-2 bg-white dark:bg-neutral-800 border-l-8 border-indigo-500 rounded shadow-md">
          ...
          {successful &&
            <section className="min-h-full min-w-full flex items-center justify-center gap-4 p-4 bg-white dark:bg-neutral-800 border-l-8 border-indigo-500 rounded shadow-md">
        ...
        <footer className="max-w-7xl w-full max-[640px]:max-w-sm grid grid-cols-3 max-[640px]:grid-cols-1 items-center gap-12 max-[640px]:gap-4 px-8">
